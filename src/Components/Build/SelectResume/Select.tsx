...
const SelectResume = () => {
 ...
 const extractName = (text: string): { full_name: string } => {
  ...
  return (
    <div className={`grid grid-cols-12 min-h-screen lg:pt-0 scrollbar-hide overflow-hidden ${isDark ? "bg-gray-900 text-white" : "bg-white text-black"}`}>
      <div className={`col-span-12 ${isDark ? "text-white" : "text-sky-700"} flex justify-center`}>
        <div>
          <p className="text-center lg:text-4xl font-bold pt-5">{t("What do you want to do?")}</p>
          <p className="lg:text-sm text-xs max-w-xs text-center pt-2">{t("Upload or build your resume and see it live in your selected template")}</p>
        </div>
      </div>
      ...
      <div className="lg:col-span-6 col-span-12 lg:py-0 py-5 flex justify-center items-center lg:pt-0 pt-15 animate__animated animate__fadeInUp">
        ...
        <Button
          ...
          buttonContent={
            <div className="w-90 flex flex-col justify-center items-center text-center bg-white rounded shadow-sm lg:px-20 lg:py-15 py-10 transition hover:shadow-md hover:-translate-y-1 duration-500">
              <CloudUpload size={40} strokeWidth={1} className="text-sky-600 mb-5" />
              <p className="font-bold text-2xl text-sky-700">{t("uploadResume")}</p>
            </div>
          }
        />
      </div>
        ...
        <Button
          ...
          buttonContent={
            <div className="w-90 flex flex-col justify-center  items-center text-center bg-white rounded shadow-sm lg:px-20 lg:py-15 py-10 transition hover:shadow-md hover:-translate-y-1 duration-500">
              ...
              <p className="font-bold text-2xl text-sky-700">{t("buildFrom")}</p>
            </div>
          }
        />
      </div>
      ...
      <div className="flex justify-start items-center font-bold">
        <Button
          onClick={() => navigate(-1)}
          buttonContent={
            <div className={`flex gap-1 lg:mx-30 ${isDark ? "text-white"  :"text-sky-400"} p-3 rounded-full px-10 `}>
